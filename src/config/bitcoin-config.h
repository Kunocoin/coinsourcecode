...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The kunocoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "kunocoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/kunocoin-project/kunocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "kunocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "kunocoin Core 0.15.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kunocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://kunocoin.org/"
