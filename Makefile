...
pkgdatadir = $(datadir)/kunocoin
pkgincludedir = $(includedir)/kunocoin
pkglibdir = $(libdir)/kunocoin
pkglibexecdir = $(libexecdir)/kunocoin
...
ACLOCAL = ${SHELL} /root/KunoCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/KunoCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/KunoCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/KunoCoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = kunocoin-cli
BITCOIN_DAEMON_NAME = kunocoind
BITCOIN_GUI_NAME = kunocoin-qt
BITCOIN_TX_NAME = kunocoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The kunocoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = kunocoin Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /root/KunoCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = kunocoin
PACKAGE_BUGREPORT = https://github.com/kunocoin-project/kunocoin/issues
PACKAGE_NAME = kunocoin Core
PACKAGE_STRING = kunocoin Core 0.15.1
PACKAGE_TARNAME = kunocoin
PACKAGE_URL = https://kunocoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/KunoCoin
abs_srcdir = /root/KunoCoin
abs_top_builddir = /root/KunoCoin
abs_top_srcdir = /root/KunoCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/KunoCoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/kunocoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/kunocoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/kunocoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/kunocoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
